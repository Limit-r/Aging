...
用法
----
  python detect/detect_fp_video.py --video FP03.mp4
  python detect/detect_fp_video.py --video FP03.mp4 --conf 0.25 --weights path/to/best.pth
"""
import argparse
import os
import sys
...
# 模型/训练代码根 = ml/  (detect_fp_video.py -> detect -> 项目根, ml/ 下含 model/utils/classifier)
