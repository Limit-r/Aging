...
VIDEO_FLASH_SECTION_TITLE = "LED 闪烁统计"
VIDEO_FLASH_CHART_TITLE = "闪烁折线图 · 累计闪烁次数 / 检测秒"
VIDEO_TIMING_SECTION_TITLE = "LED 亮 / 灭时刻"
VIDEO_FLASH_X_LABEL = "检测时间 (s)"
VIDEO_FLASH_Y_LABEL = "累计闪烁"
VIDEO_TIMING_ON_TEMPLATE = "亮 {s}s"
VIDEO_TIMING_ON_NONE = "亮 —"
VIDEO_TIMING_OFF_TEMPLATE = "灭 {s}s"
VIDEO_TIMING_FLASH_TEMPLATE = "闪 {n}"
