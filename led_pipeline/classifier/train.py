"""
训练 LED 亮灭二分类模型 (TinyConv)。

用法:
    python led_pipeline/classifier/train.py

输出:
    led_pipeline/classifier/weights/best_tinyconv.pth
    led_pipeline/classifier/weights/best_tinyconv.onnx
"""
import argparse
import os
import sys
...
def main():
    ...
    try:
        ...
        onnx_path = str(OUTPUT_DIR / f'best_{args.model}.onnx')
