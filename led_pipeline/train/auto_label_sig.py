...
用法:
  ...
  python led_pipeline/train/auto_label_sig.py
...
DATASET_DIR = r'd:\Aging\led_pipeline\datasets\A'
JPEG_DIR = os.path.join(DATASET_DIR, 'JPEGImages')
ANNO_DIR = os.path.join(DATASET_DIR, 'Annotations')
WEIGHTS = r'd:\Aging\led_pipeline\train\weights\A\model_best_precision_deploy.pt'
