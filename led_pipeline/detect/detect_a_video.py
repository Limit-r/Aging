...
用法:
  python led_pipeline/detect/detect_a_video.py --video D:\Aging\Video\001.mp4
  python led_pipeline/detect/detect_a_video.py --video D:\Aging\Video\001.mp4 --conf 0.25
"""
import argparse
import os
import sys
...
# ===== 默认路径 =====
A_WEIGHTS = r'd:\Aging\led_pipeline\train\weights\A\model_best_precision_deploy.pt'
A_LABELS  = r'd:\Aging\led_pipeline\datasets\A\label_5class.txt'
A_CLF_WEIGHTS = r'd:\Aging\led_pipeline\classifier\weights\best_tinyconv_a.pth'
A_OUTDIR  = r'd:\Aging\led_pipeline\detect\outputs'
