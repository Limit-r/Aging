...
用法:
  python led_pipeline/ablation/scripts/run_ablation.py              # 完整运行
  python led_pipeline/ablation/scripts/run_ablation.py --infer-only # 仅推理
  python led_pipeline/ablation/scripts/run_ablation.py --single 640_baseline  # 单实验
"""
import argparse
import json
import os
